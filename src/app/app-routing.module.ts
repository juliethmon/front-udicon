...
const routes: Routes = [
  ...
  { path: 'ProjectHistory', component: HistorialProyectComponent },
  { path: 'Usuarios', component: AdminPageComponent },
  { path: 'Users', component: UsersAdmiComponent },
  { path: 'Material/:id', component: AdminMaterialComponent },
  { path: 'AgendarCita', component: HistoryBuyComponent  },
